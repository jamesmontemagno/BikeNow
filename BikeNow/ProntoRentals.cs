...
namespace BikeNow
{
	...
	public class ProntoRentals
	{
		const string ProntoLoginUrl = "https://secure.prontocycleshare.com/en/profile/login";
		const string ProntoRentalsUrl = "https://www.thehubway.com/member/rentals";
